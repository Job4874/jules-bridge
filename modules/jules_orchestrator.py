...
def _compile_fleet_retry_packets(
    existing_launch_state: dict, remote_status_rows: list[dict]
    ...
    return failed_packet_files, stale_unknown_packet_files, plan_awaiting_packet_files, retry_packet_files
...
def run_jules_fleet(
    ...
    try:
        ...
        (
            ...
            retry_packet_files,
        ) = _compile_fleet_retry_packets(existing_launch_state, remote_status_rows)
        ...
        return _build_fleet_payload(
            ...
            sessions_result=dict(sessions_result),
            ...
            launch_dry_run=launch_dry_run,
            launch_result=dict(launch_result),
            pull_results=[dict(r) for r in pull_results],
            cot_result=dict(cot_result),
