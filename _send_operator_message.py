...
sys.path.insert(0, r"C:\Users\abdul\.jules")

from modules.jules_orchestrator import launch_packets

packet_dir = Path(r"C:\Users\abdul\.jules\jules_inbox\jules_dispatch_operator")
packet_dir.mkdir(parents=True, exist_ok=True)

packet = packet_dir / "OP-001-email-operator.md"
packet.write_text(
...
result = launch_packets(
    ...
    timeout_s=120,
    write_state=True,
    state_path=str(packet_dir / "JULES_LAUNCH_STATE.json"),
)
print(result)
