...
## Session 20260722T103420 - Full Codebase Verification & Claim Proof (/tdd /goal /god)
...
- Handled optional data-science dependencies in `tests/test_tibin_core.py` with `pytest.importorskip("pandas")`.
